...
-- AddForeignKey
ALTER TABLE "Institution" ADD CONSTRAINT "Institution_institutionVerificationId_fkey" FOREIGN KEY ("institutionVerificationId") REFERENCES "InstitutionVerification"("id") ON DELETE CASCADE ON UPDATE CASCADE;
